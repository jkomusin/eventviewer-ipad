...
@property (nonatomic, strong) PanelDrawView *bandDrawView;      // The static View in which all bands are drawn. Is the view that is zoomed and panned by this ScrollView.
